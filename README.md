...
- (終了) 第42回 2016/3/2 : P355-360 14.7 モナディック関数の合成 ( [Some useful monadic functions](http://learnyouahaskell.com/for-a-few-monads-more#useful-monadic-functions)
    * **会場の都合により 2/24 から 3/2 に延期になりました** 
      (参加者には事前に連絡済み)
- (終了) 第43回 2016/3/9 : P360-P360 14.8 モナドを作る
    * 
- (終了) 第44回 2016/3/23 : P360-363 14.8 モナドを作る
    * **参加者の都合により、3/16 から 3/23 に延期になりました**
      年度末なため、今後も 3月中、4月頭の開催は延期される可能性があります。
      ご了承ください。
- (終了) 【 最終回 】 第45回 2016/3/30 : P363-367 15章 Zipper
    - 最終回になる可能性が高く、いったん終了と相成りました。
    - P367以降は、各自進めることになります
